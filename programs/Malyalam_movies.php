...
$sql="SELECT m.postercardurl,m.pageurl FROM movies m  inner JOIN languagebridge lb on m.movieid=lb.movieid where lb.languageid=3 ORDER BY `m`.`postercardurl` DESC";
