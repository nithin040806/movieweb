...
$_SESSION['movieid']=15;
$b=$_SESSION['movieid'];
$_SESSION['pageurl']="http://localhost/project/programs/Transformers_Rise_of_the_Beasts.php";
...
<?php 
  ...
  $sql4="SELECT m.postercardurl,m.pageurl FROM movies m  RIGHT JOIN languagebridge lb on m.movieid=lb.movieid WHERE lb.languageid=4 ORDER BY `m`.`postercardurl` ASC";
