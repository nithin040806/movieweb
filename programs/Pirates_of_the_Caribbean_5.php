...
$_SESSION['movieid']=45;
$b=$_SESSION['movieid'];
$_SESSION['pageurl']="http://localhost/project/programs/Pirates_of_the_Caribbean_5.php";
...
<?php 
  ...
  $sql4="SELECT m.postercardurl,m.pageurl FROM movies m  RIGHT JOIN languagebridge lb on m.movieid=lb.movieid WHERE lb.languageid=4 ORDER BY `m`.`postercardurl` DESC";
