...
$_SESSION['movieid']=2;
$_SESSION['pageurl']="http://localhost/project/programs/Chakravyuham.php";
$user_data=check_login($con);
$a=$user_data['userid'] ;
$sql3="SELECT * from watchlist where movieid=2 AND userid=$a";
$result=mysqli_query($con,$sql3);
$watch=mysqli_fetch_assoc($result);
$sql5="SELECT * from favourite where movieid=2 AND userid=$a";
