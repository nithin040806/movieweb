...
$_SESSION['movieid']=16;
$b=$_SESSION['movieid'];
$_SESSION['pageurl']="http://localhost/project/programs/Bhediya.php";
...
<?php 
  ...
  $sql4="SELECT m.postercardurl,m.pageurl FROM movies m  RIGHT JOIN languagebridge lb on m.movieid=lb.movieid WHERE lb.languageid=2 ORDER BY `m`.`postercardurl` ASC";
