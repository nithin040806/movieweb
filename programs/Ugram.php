...
$_SESSION['movieid']=8;
$_SESSION['pageurl']="http://localhost/project/programs/Ugram.php";
$user_data=check_login($con);
$a=$user_data['userid'] ;
$sql3="SELECT * from watchlist where movieid=8 AND userid=$a";
$result=mysqli_query($con,$sql3);
$watch=mysqli_fetch_assoc($result);
$sql5="SELECT * from favourite where movieid=8 AND userid=$a";
...
<?php 
  ...
  $sql="SELECT * FROM movies WHERE movieid=8";
  $car=$conn->query($sql);
