...
$_SESSION['movieid']=26;
$b=$_SESSION['movieid'];
$_SESSION['pageurl']="http://localhost/project/programs/Christy.php";
...
<?php 
  ...
  $sql4="SELECT m.postercardurl,m.pageurl FROM movies m  RIGHT JOIN languagebridge lb on m.movieid=lb.movieid WHERE lb.languageid=3 ORDER BY `m`.`postercardurl` DESC";
