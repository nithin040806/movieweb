...
$sql="SELECT m.postercardurl,m.pageurl,m.movieid FROM movies m  inner JOIN languagebridge lb on m.movieid=lb.movieid where m.releaseyear=2023 ORDER BY `m`.`movieid` DESC";
