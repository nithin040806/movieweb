...
$_SESSION['movieid']=21;
$b=$_SESSION['movieid'];
$_SESSION['pageurl']="http://localhost/project/programs/Kisi_Ka_Bhai_Kisi_Ki_Jaan.php";
...
<?php 
  ...
  $sql4="SELECT m.postercardurl,m.pageurl FROM movies m  RIGHT JOIN languagebridge lb on m.movieid=lb.movieid WHERE lb.languageid=2 ORDER BY `m`.`postercardurl` DESC";
