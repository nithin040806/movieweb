...
$_SESSION['movieid']=33;
$b=$_SESSION['movieid'];
$_SESSION['pageurl']="http://localhost/project/programs/Ponniyin_Selvan_Part1.php";
...
<?php 
  ...
  $sql4="SELECT m.postercardurl,m.pageurl FROM movies m  RIGHT JOIN languagebridge lb on m.movieid=lb.movieid WHERE lb.languageid=5 ORDER BY `m`.`postercardurl` DESC";
